...
def run_mlp_md(
    ...
    **kwargs,
    ...
    if delta_time < 60:
        ...
        logger.info(
            f'MLP MD simulation completed in {int(hours):02d} h {int(minutes):02d} min {int(seconds):02d} s.'
        )
...
def _run_mlp_md(
    ...
    **kwargs,
    ...
    logger.debug(f'Ase Atoms: {ase_atoms}')
    logger.debug(f'Traj Name: {traj_name}')
    ...
    logger.debug(f'Updated Energies: {energies}')
